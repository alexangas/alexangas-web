...
export type SitePluginPluginOptionsGatsbyRemarkPluginsOptions = {
  ...
  theme?: Maybe<SitePluginPluginOptionsGatsbyRemarkPluginsOptionsTheme>;
};
...
export type SitePluginPluginOptionsGatsbyRemarkPluginsOptionsFilterInput = {
  ...
  theme?: Maybe<SitePluginPluginOptionsGatsbyRemarkPluginsOptionsThemeFilterInput>;
};

export type SitePluginPluginOptionsGatsbyRemarkPluginsOptionsTheme = {
  default?: Maybe<Scalars['String']>;
  dark?: Maybe<Scalars['String']>;
};

export type SitePluginPluginOptionsGatsbyRemarkPluginsOptionsThemeFilterInput = {
...
export type FooterQueryQuery = { site?: Maybe<{ siteMetadata?: Maybe<(
      Pick<SiteSiteMetadata, 'author'>
      & { social?: Maybe<Pick<SiteSiteMetadataSocial, 'github' | 'linkedin'>> }
    )> }> };

export type NavBarQueryQueryVariables = {};


export type NavBarQueryQuery = { site?: Maybe<{ siteMetadata?: Maybe<Pick<SiteSiteMetadata, 'title'>> }> };
...
export type BlogHomeQueryQueryVariables = {};


export type BlogHomeQueryQuery = { allMdx: { edges: Array<{ node: (
        Pick<Mdx, 'excerpt'>
        & { fields?: Maybe<Pick<MdxFields, 'slug'>>, frontmatter?: Maybe<Pick<MdxFrontmatter, 'date' | 'title' | 'description' | 'tags'>> }
      ) }> } };

export type TagsPageQueryQueryVariables = {};


export type TagsPageQueryQuery = { allMdx: { group: Array<Pick<MdxGroupConnection, 'fieldValue' | 'totalCount'>> } };
...
export type BlogPostBySlugQuery = { site?: Maybe<{ siteMetadata?: Maybe<Pick<SiteSiteMetadata, 'title' | 'author'>> }>, avatar?: Maybe<{ childImageSharp?: Maybe<{ fixed?: Maybe<GatsbyImageSharpFixedFragment> }> }>, mdx?: Maybe<(
